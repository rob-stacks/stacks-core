...
fn check_allowances(
    ...
    let mut ft_allowances: HashMap<AssetIdentifier, Vec<(usize, u128)>> =
        crate::vm::collections::new_map();
    ...
    let mut nft_allowances: HashMap<AssetIdentifier, (usize, Vec<Value>)> =
        crate::vm::collections::new_map();
    // Elements are (index in allowances, amount)
